...
struct Translations {
	...
	static let FAQ_SECTION_APP_ANDROID_ANSWER = NSLocalizedString("FAQ_SECTION_APP_ANDROID_ANSWER", comment: "")
	static let FAQ_SECTION_APP_ANDROID_QUESTION = NSLocalizedString("FAQ_SECTION_APP_ANDROID_QUESTION", comment: "")
	static let FAQ_SECTION_APP_REPORT_ANSWER = NSLocalizedString("FAQ_SECTION_APP_REPORT_ANSWER", comment: "")
	static let FAQ_SECTION_APP_REPORT_QUESTION = NSLocalizedString("FAQ_SECTION_APP_REPORT_QUESTION", comment: "")
	static let FAQ_SECTION_APP_SUGGESTION_ANSWER = NSLocalizedString("FAQ_SECTION_APP_SUGGESTION_ANSWER", comment: "")
	static let FAQ_SECTION_APP_SUGGESTION_QUESTION = NSLocalizedString("FAQ_SECTION_APP_SUGGESTION_QUESTION", comment: "")
	static let FAQ_SECTION_APP_TITLE = NSLocalizedString("FAQ_SECTION_APP_TITLE", comment: "")
	static let FAQ_SECTION_DATA_CALCULATION_ANSWER = NSLocalizedString("FAQ_SECTION_DATA_CALCULATION_ANSWER", comment: "")
	static let FAQ_SECTION_DATA_CALCULATION_QUESTION = NSLocalizedString("FAQ_SECTION_DATA_CALCULATION_QUESTION", comment: "")
	static let FAQ_SECTION_DATA_SOURCE_ANSWER = NSLocalizedString("FAQ_SECTION_DATA_SOURCE_ANSWER", comment: "")
	static let FAQ_SECTION_DATA_SOURCE_QUESTION = NSLocalizedString("FAQ_SECTION_DATA_SOURCE_QUESTION", comment: "")
	static let FAQ_SECTION_DATA_TITLE = NSLocalizedString("FAQ_SECTION_DATA_TITLE", comment: "")
	static let FAQ_SECTION_DATA_UPDATE_ANSWER = NSLocalizedString("FAQ_SECTION_DATA_UPDATE_ANSWER", comment: "")
	static let FAQ_SECTION_DATA_UPDATE_QUESTION = NSLocalizedString("FAQ_SECTION_DATA_UPDATE_QUESTION", comment: "")
	static let FAQ_TITLE = NSLocalizedString("FAQ_TITLE", comment: "")
	...
	static let ONBOARDING_BUTTON_DONE = NSLocalizedString("ONBOARDING_BUTTON_DONE", comment: "")
	static let ONBOARDING_BUTTON_NEXT = NSLocalizedString("ONBOARDING_BUTTON_NEXT", comment: "")
	static let ONBOARDING_PAGE_LOCATION = NSLocalizedString("ONBOARDING_PAGE_LOCATION", comment: "")
	static let ONBOARDING_PAGE_LOOKUP = NSLocalizedString("ONBOARDING_PAGE_LOOKUP", comment: "")
	static let ONBOARDING_PAGE_TARIFS = NSLocalizedString("ONBOARDING_PAGE_TARIFS", comment: "")
	static let ONBOARDING_PAGE_VARIABLE_COSTS = NSLocalizedString("ONBOARDING_PAGE_VARIABLE_COSTS", comment: "")
